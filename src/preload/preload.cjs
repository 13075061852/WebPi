...
contextBridge.exposeInMainWorld("halo", {
  ...
  projectRunStart: () => ipcRenderer.invoke('halo:project-run-start'),
  projectRunList: () => ipcRenderer.invoke('halo:project-run-list'),
  projectRunStop: id => ipcRenderer.invoke('halo:project-run-stop', id),
  onProjectRun: listen('halo:project-run'),
  ...
  videoConfirm: input => ipcRenderer.invoke('halo:video-confirm', input),
  videoConfirmations: () => ipcRenderer.invoke('halo:video-confirmations'),
  ...
  renameSession: (file, name) => ipcRenderer.invoke("halo:rename-session", file, name),
  ...
  artifactFiles: (files, options) => ipcRenderer.invoke("halo:artifact-files", files, options),
